    ...
    return (
        <Container>
            ...
            <Form>
                ...
                <Form.Control type="text" placeholder="Eg: Portal 2 mapping, TF2 matchmaking, etc" id={NAME} />
                <br />
                <Form.Label>Game</Form.Label>
                <Form.Control type="text" placeholder="Eg: Portal 2, Team Fortress 2, Counter Strike: Global Offensive, etc" id={GAME} />
                <br />
                <Form.Label>Description</Form.Label>
                <Form.Control type="text" placeholder="Eg: This room is for meeting up for TF2 matchmaking, etc" id={DESCRIPTION} />
                <br />
